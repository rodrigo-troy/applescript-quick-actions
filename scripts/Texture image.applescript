on run {input, parameters}
	-- Apply Pixelmator Pro's texture adjustment at intensity 20 (20% of the 0–100 slider)
	-- to each selected image. Saves a new file alongside the original with a "-textured"
	...
	display notification "Adding texture to " & totalFiles & " image(s)..." with title "Texture" sound name "default"
	...
	if errorCount is 0 then
		display alert "Texture Complete" message (processedCount as string) & " image(s) textured."
	else
